...
const RegisterUserPage = () => {
      ...
      if (password === confirmPassword) {
        axios
          ...
          .then((res) => {
            ...
            history.push("/login", { email: email, password: password, biz: false });
          })
          .catch((err) => {
  ...
  return (
    ...
    <form className="row media media-100" onSubmit={handleSubmit}>
        <h1>Registration for Private</h1>
        <h3>If you are a private person and need our service, you are welcome to open a new user for free!</h3>
      <div className="mb-3">
      ...
      {showPasswordErrorMsg && (
        <div className="alert col-4 mb-5" role="alert">
